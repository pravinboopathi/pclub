...
const About = () => {
    ...
    return (
        <div id="about" className=" bg-[#1f2937] mt-20 px-6 md:px-28 py-10 md:py-28">
            <div className=" md:grid grid-cols-2 gap-8 ">
                <div>
                    <h1 className="text-xl md:text-3xl font-semibold pt-2 md:pt-20 pb-3 text-gray-200">About Our Programming Club</h1>
                    <p className="text-gray-400 text-sm md:text-xl pb-6 md:pb-16">We foster innovation, collaboration, and the spirit of coding excellence in our vibrant community.</p>
                    <div className="flex items-center">
                        <div>
                            {Points.map((item, index) => (
                                <div key={index}  className="flex items-center text-blue-400 text-sm md:text-xl leading-10 md:leading-[60px]">
                                    <FaCode className=" text-2xl md:text-4xl text-white mr-2" />
                                    <p>{item}</p>
                                </div>
                            ))}
                        </div>
