...
//                     </li>
//                     <li className="text-xl cursor-pointer md:my-0 my-2 text-left md:text-center">
//                         <ScrollLink to="gallery" smooth={true} duration={500} className="md:ml-8 text-[#f638dc] hover:text-gray-400 duration-300">Gallery</ScrollLink>
//                     </li>
//                     <li className="text-xl cursor-pointer md:my-0 my-2 text-left md:text-center">
//                         <div onClick={() => handleNavigation("/partners")} className="md:ml-8 text-[#f638dc] hover:text-gray-400 duration-300">Partners</div>
//                     </li>
//                     <li className="text-xl cursor-pointer md:my-0 my-2 text-left md:text-center">
//                         <ScrollLink to="about" smooth={true} duration={500} className="md:ml-8 text-[#f638dc] hover:text-gray-400 duration-300">About us</ScrollLink>
//                     </li>
//                     <li className="text-xl cursor-pointer md:my-0 my-2 text-left md:text-center">
